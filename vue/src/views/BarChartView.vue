<template>
  ...
  <div>
    ...
    :ChronicLiverProp="ChronicLiver" ></PieChartTotal>
    ...
    fetchData: async function () {
      ...
      try {
        ...
        this.data.forEach((item)=> {
          ...
          if(item.leading_cause === "Mental and Behavioral Disorders due to Accidental Poisoning and Other Psychoactive Substance Use (F11-F16, F18-F19, X40-X42, X44)"){
          ...
          if(item.leading_cause === "Certain Conditions originating in the Perinatal Period (P00-P96)"){
          ...
          if(item.leading_cause === "Congenital Malformations, Deformations, and Chromosomal Abnormalities (Q00-Q99)"){
